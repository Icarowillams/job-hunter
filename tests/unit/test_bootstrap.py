...
""",
    ...
    assert runner.collector.api_key == "test-serpapi-key"
    assert runner.collector.query == "estágio python"
    assert runner.collector.location == "Recife, PE"
    assert runner.collector.limit == 15
